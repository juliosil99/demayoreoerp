    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-col md:flex-row md:gap-4">
        <p className="text-muted-foreground">
          <span className="font-medium">Saldo actual:</span> {formatCurrency(account.balance, account.currency)}
        </p>
        <p className="text-muted-foreground">
          <span className="font-medium">Saldo inicial:</span> {formatCurrency(account.initial_balance, account.currency)} 
