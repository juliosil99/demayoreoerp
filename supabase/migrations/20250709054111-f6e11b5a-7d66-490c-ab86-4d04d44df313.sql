-- Mejorar el trigger de inicialización de empresa para crear cuentas básicas
...
AS $$
BEGIN
  -- Insert the user as admin in company_users table
...
CREATE TRIGGER on_company_created
  ...
  FOR EACH ROW EXECUTE FUNCTION public.handle_new_company_with_accounts();