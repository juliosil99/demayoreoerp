-- Fix trigger to handle both unique constraints on company_users
...
BEGIN
  ...
  -- Handle both unique constraints: (company_id, user_id) and (user_id, company_id)
  INSERT INTO public.company_users (company_id, user_id, role)
  VALUES (NEW.id, NEW.user_id, 'admin')
  ON CONFLICT ON CONSTRAINT company_users_company_id_user_id_key DO NOTHING
  ON CONFLICT ON CONSTRAINT company_users_user_company_unique DO NOTHING;
